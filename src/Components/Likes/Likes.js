...
const Likes = (props) => {
    return (
        <div className="like">
            <svg width="11" height="11" xmlns="http://www.w3.org/2000/svg" className='like--plus'>
            ...
            <p className='like--score'>{props.score}</p>
            <svg width="11" height="3" xmlns="http://www.w3.org/2000/svg" className='like--minus'>
